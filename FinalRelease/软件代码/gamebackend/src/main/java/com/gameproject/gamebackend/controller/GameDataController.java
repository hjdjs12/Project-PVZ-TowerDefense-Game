...
public class GameDataController {
    ...
    */
    ...
    public String setGameDataS(@RequestBody GameData gameData) {
        return gameDataService.setDataIndS(gameData);
    }

    @GetMapping("setDataIndL")
    public String setGameDataL(@RequestBody GameData gameData) {
    ...
    public String getDataIndS(@RequestBody GameData gameData) {
    ...
    public String getDataIndL(@RequestBody GameData gameData) {
    ...
    @GetMapping("verLogin")
    public String verLogin(@RequestBody GameData gameData) {
    ...
    @GetMapping("register")
    public String register(@RequestBody GameData gameData) {
        String result;
        if ((result = gameDataService.register(gameData)).equals("注册成功")) {
            return "注册成功";
        }
        return result;
    }
