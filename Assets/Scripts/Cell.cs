...
public class Cell : MonoBehaviour
{
    ...
    public bool AddPlant(Plant plant)
    {
        ...
        else if (currentPlant != null && currentPlant.plantType == PlantType.Tower && currentPlant2 != null && ((currentPlant2.plantType == PlantType.MG1 && plant.plantType == PlantType.MG2)   || (currentPlant.plantType == PlantType.Cannon1 && plant.plantType == PlantType.Cannon2 )))
        {//种植二级进化武器
            Destroy(currentPlant2.gameObject);
            WeaponManager.Instance.weaponList.Remove(currentPlant2.gameObject);
            centerPosition.z = -5;
